...
const Nav = () => {
  ...
  return (
    <nav ref={ref} className="flex fixed z-50 bg-gradient-to-r from-background-2/0 to-background-3/0 top-0 left-0 w-full transition duration-500 justify-between h-12 items-center px-8 sm:px-10 md:px-14 xl:px-16 xl:h-14 3xl:h-16 3xl:px-20">
      ...
      <div
        className={`bg-green-sidc pt-20 gap-y-6 fixed w-full transition-[left] duration-100 ${menuOpen ? "left-0" : "left-full"} right-0 top-0 flex flex-col text-white text-3xl items-center h-full gap-3 xs:static xs:pt-0 xs:w-fit xs:flex-row xs:bg-inherit xs:text-inherit xl:text-slate-600 xs:text-base xs:gap-3.5 sm:gap-6 md:text-lg lg:gap-7 xl:gap-8 xl:text-xl 3xl:text-2xl 3xl:gap-10`}
